...
<div class="container w-50 mt-4">
        <form action="../../index.php?action=addPost" method="post" enctype="multipart/form-data"> <!-- ICI -->
            <div>
            ...
            <div class="mb-3">
              ...
              <input class="form-control" name="image" type="file" id="formFile"> <!-- ICI -->
            </div>
            <div>
                <input type="submit" name="submit" class="btn btn-primary mb-3"> <!-- ICI -->
            </div>
        </form>
    </div>
